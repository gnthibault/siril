...
#define STR_SEQSTAT N_("Same command as STAT bit for sequence \"sequencename\". The output is saved in a csv file given in second argument. The optional parameter can be \"basic\" or \"extra\". The last gives much more information but will take more time to compute everything")
