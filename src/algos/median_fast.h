...
inline __attribute__((always_inline)) float median9x9(float* array)
{
...
inline __attribute__((always_inline)) __m128 median3x3sse(__m128* array)
{
...
inline __attribute__((always_inline)) __m128 median5x5sse(__m128* array)
{
...
inline __attribute__((always_inline)) __m128 median7x7sse(__m128* array)
{
...
inline __attribute__((always_inline)) __m128 median9x9sse(__m128* array)
{
